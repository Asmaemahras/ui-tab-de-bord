import { savings } from "../../donnees/donnee";
import { iconsImgs, personsImgs } from "../../utils/img";
import "./Savings.css";
                        ...
                        <div className="grid-item" key = { saving.id }>
                            ...
                            <div className="grid-item-bottom">
                                <div className="grid-item-badges">
                                    <span className="grid-item-badge">Date de prélévement { saving.date_taken }</span>
                                    <span className="grid-item-badge">Montant restant € { saving.amount_left }</span>
                                </div>
